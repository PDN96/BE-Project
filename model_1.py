...
#print(train_x)
layers_dims = [1800, 100, 7] #  5-layer model



def L_layer_model(X, Y, layers_dims, learning_rate_init = 0.0625, learning_rate_final = 0.00625, num_iterations = 1000, print_cost=False):#lr was 0.009
    """
    ...
    k=(learning_rate_final-learning_rate_init)/num_iterations
    ...
    for i in range(0, num_iterations):
        ...
        if((i+1)%20==0):
            learning_rate=(k*i)+learning_rate_init
